...
class PGConnection:
    ...
    def delete_foreign_key(self, table_name: str, fk_name: str):
        sqlstring: str = f"ALTER TABLE {table_name} DROP CONSTRAINT {fk_name}"
    ...
    def delete_table(self, table_name: str):
        sqlstring: str = f"DROP TABLE {table_name}"
    ...
    def disable_foreign_keys_on_table(self, table_name: str):
        sqlstring: str = f"ALTER TABLE {table_name} DISABLE TRIGGER ALL;"
    ...
    def enable_foreign_keys_on_table(self, table_name: str):
        sqlstring: str = f"ALTER TABLE {table_name} ENABLE TRIGGER ALL;"
