...
def test_gets_fantasy_teams_with_ids_filter() -> None:
    ...
    posted_item_1: list[FantasyTeamModel] = [
    ...
    posted_item_2: list[FantasyTeamModel] = [
    ...
    posted_item_3: list[FantasyTeamModel] = [
    ...
    posted_item_4: list[FantasyTeamModel] = [
...
def test_gets_league_players_with_ids_filter_with_hydration() -> None:
    ...
    assert_objects_are_equal(
        posted_item_1[0], posted_object_1, ["owner", "fantasy_league"]
    )

    fantasy_team_hydration_check(posted_item_1[0])
    ...
    assert len(posted_item_2) == 1
    assert_objects_are_equal(
        posted_item_2[0], posted_object_2, ["owner", "fantasy_league"]
    )

    fantasy_team_hydration_check(posted_item_2[0])
    ...
    assert len(posted_item_3) == 1
    assert_objects_are_equal(
        posted_item_3[0], posted_object_3, ["owner", "fantasy_league"]
    )

    fantasy_team_hydration_check(posted_item_3[0])
    ...
    assert len(posted_item_4) == 1
    assert_objects_are_equal(
        posted_item_4[0], posted_object_4, ["owner", "fantasy_league"]
    )

    fantasy_team_hydration_check(posted_item_4[0])
...
def test_gets_fantasy_teams_with_paging() -> None:
    ...
    posted_item_page_1_item_1: list[FantasyTeamModel] = [
    ...
    posted_item_page_1_item_2: list[FantasyTeamModel] = [
    ...
    posted_item_page_2_item_1: list[FantasyTeamModel] = [
    ...
    posted_item_page_2_item_2: list[FantasyTeamModel] = [
