...
def test_gets_league_teams_with_ids_filter() -> None:
    ...
    result_item_1: list[LeagueTeamModel] = [
    ...
    result_item_2: list[LeagueTeamModel] = [
    ...
    result_item_3: list[LeagueTeamModel] = [
    ...
    result_item_4: list[LeagueTeamModel] = [
...
def test_gets_league_teams_with_ids_filter_with_hydration() -> None:
    ...
    assert len(result_item_1) == 1
    assert_objects_are_equal(result_item_1[0], posted_object_1, ["home_venue"])

    assert result_item_1[0].home_venue is not None
    assert result_item_1[0].home_venue.id is not None
    assert result_item_1[0].home_venue.id == result_item_1[0].home_venue_id

    result_item_2: list[LeagueTeamModel] = [
        item for item in result.items if item.id == posted_object_2.id
    ]
    assert len(result_item_2) == 1
    assert_objects_are_equal(result_item_2[0], posted_object_2, ["home_venue"])

    assert result_item_2[0].home_venue is not None
    assert result_item_2[0].home_venue.id is not None
    assert result_item_2[0].home_venue.id == result_item_2[0].home_venue_id

    result_item_3: list[LeagueTeamModel] = [
        item for item in result.items if item.id == posted_object_3.id
    ]
    assert len(result_item_3) == 1
    assert_objects_are_equal(result_item_3[0], posted_object_3, ["home_venue"])

    assert result_item_3[0].home_venue is not None
    assert result_item_3[0].home_venue.id is not None
    assert result_item_3[0].home_venue.id == result_item_3[0].home_venue_id

    result_item_4: list[LeagueTeamModel] = [
        item for item in result.items if item.id == posted_object_4.id
    ]
    assert len(result_item_4) == 1
    assert_objects_are_equal(result_item_4[0], posted_object_4, ["home_venue"])

    assert result_item_4[0].home_venue is not None
    assert result_item_4[0].home_venue.id is not None
    assert result_item_4[0].home_venue.id == result_item_4[0].home_venue_id
...
def test_gets_league_teams_with_paging() -> None:
    ...
    result_item_page_1_item_1: list[LeagueTeamModel] = [
    ...
    result_item_page_1_item_2: list[LeagueTeamModel] = [
    ...
    result_item_page_2_item_1: list[LeagueTeamModel] = [
    ...
    result_item_page_2_item_2: list[LeagueTeamModel] = [
